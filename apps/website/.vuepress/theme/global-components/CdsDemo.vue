  ...
  <div>
    ...
    >
      <div class="code-actions">
        <button cds-text="caption uppercase" class="code-action" @click="copyCode()">
          copy code
        </button>
        <button cds-text="caption uppercase" class="code-action" @click="toggleState()" v-if="showToggle">
